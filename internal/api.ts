...
export const ImageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getImageBingDaily: async (date?: string, resolution?: GetImageBingDailyResolutionEnum, format?: GetImageBingDailyFormatEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        postImageOcr: async (file?: File, url?: string, imageBase64?: string, imageName?: string, needLocation?: PostImageOcrNeedLocationEnum, returnMarkdown?: PostImageOcrReturnMarkdownEnum, enableCls?: PostImageOcrEnableClsEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ImageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getImageBingDaily(date?: string, resolution?: GetImageBingDailyResolutionEnum, format?: GetImageBingDailyFormatEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getImageBingDaily(date, resolution, format, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async postImageOcr(file?: File, url?: string, imageBase64?: string, imageName?: string, needLocation?: PostImageOcrNeedLocationEnum, returnMarkdown?: PostImageOcrReturnMarkdownEnum, enableCls?: PostImageOcrEnableClsEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PostImageOcr200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postImageOcr(file, url, imageBase64, imageName, needLocation, returnMarkdown, enableCls, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ImageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getImageBingDaily(date?: string, resolution?: GetImageBingDailyResolutionEnum, format?: GetImageBingDailyFormatEnum, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.getImageBingDaily(date, resolution, format, options).then((request) => request(axios, basePath));
        },
        /**
         * 这个接口用于查询必应壁纸历史列表，也可以按日期精确查询某一天。默认按时间倒序返回 JSON。  ## 功能概述 - 可以传 `date` 精确查询某一天，命中后只返回 1 条数据 - 不传 `date` 时，按时间倒序分页返回历史列表 - 可以传 `resolution` 让 `image_url` 直接对应 `4k` 或 `1080` - 可以传 `page` 和 `page_size` 控制分页 - 每条记录都是扁平 JSON 对象，里面会包含标题、副标题、说明文案、版权信息、问答信息和图片地址等字段  ## 参数说明 `resolution` 默认是 `4k`。 `page` 默认是 `1`，`page_size` 默认是 `30`，最大是 `100`。 当传了 `date` 以后，`page` 和 `page_size` 不生效。
         * @summary 查询必应壁纸历史
         ...
         * @throws {RequiredError}
         */
        postImageOcr(file?: File, url?: string, imageBase64?: string, imageName?: string, needLocation?: PostImageOcrNeedLocationEnum, returnMarkdown?: PostImageOcrReturnMarkdownEnum, enableCls?: PostImageOcrEnableClsEnum, options?: RawAxiosRequestConfig): AxiosPromise<PostImageOcr200Response> {
            return localVarFp.postImageOcr(file, url, imageBase64, imageName, needLocation, returnMarkdown, enableCls, options).then((request) => request(axios, basePath));
        },
        /**
         * 你们怎么不说话了？是不是都在偷偷玩Uapi，求求你们不要玩Uapi了  ## 使用须知 - **响应格式**：接口成功时直接返回 `image/png` 格式的二进制数据。 - **文字内容**：至少需要提供 `top_text`（上方文字）或 `bottom_text`（下方文字）之一。 - **梗图逻辑**：上方描述某个行为，下方通常以「们」开头表示劝阻，形成戏谑的对比效果。
         * @summary 生成你们怎么不说话了表情包
...
export class ImageApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public getImageBingDaily(date?: string, resolution?: GetImageBingDailyResolutionEnum, format?: GetImageBingDailyFormatEnum, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).getImageBingDaily(date, resolution, format, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public postImageOcr(file?: File, url?: string, imageBase64?: string, imageName?: string, needLocation?: PostImageOcrNeedLocationEnum, returnMarkdown?: PostImageOcrReturnMarkdownEnum, enableCls?: PostImageOcrEnableClsEnum, options?: RawAxiosRequestConfig) {
        return ImageApiFp(this.configuration).postImageOcr(file, url, imageBase64, imageName, needLocation, returnMarkdown, enableCls, options).then((request) => request(this.axios, this.basePath));
    }
...
export const MiscApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {boolean} [full] 使用这个参数可以获得完整的物流信息。但会消耗34积分/一次（不过缓存命中半价）。因为成本实在太贵了，否则非常非常亏说是
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMiscTrackingQuery: async (trackingNumber: string, carrierCode?: string, phone?: string, full?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'trackingNumber' is not null or undefined
...
export const MiscApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMiscTrackingQuery(trackingNumber: string, carrierCode?: string, phone?: string, full?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetMiscTrackingQuery200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMiscTrackingQuery(trackingNumber, carrierCode, phone, full, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const MiscApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getMiscTrackingQuery(trackingNumber: string, carrierCode?: string, phone?: string, full?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<GetMiscTrackingQuery200Response> {
            return localVarFp.getMiscTrackingQuery(trackingNumber, carrierCode, phone, full, options).then((request) => request(axios, basePath));
        },
        /**
         * 出门前，查一下天气总是个好习惯。这个接口为你提供精准、实时的天气数据，支持国内和国际城市。  ## 功能概述 这个接口支持三种查询方式： - 可以传 `adcode`，按行政区编码查询（优先级最高） - 可以传 `city`，按城市名称查询，支持中文（`北京`）和英文（`Tokyo`） - 两个都不传时，按客户端 IP 自动定位查询  支持 `lang` 参数，可选 `zh`（默认）和 `en`，城市名翻译覆盖 7000+ 城市。  ## 可选功能模块 - `extended=true`：扩展气象字段（体感温度、能见度、气压、紫外线、空气质量及污染物分项数据） - `forecast=true`：多天预报（最多7天，会额外返回每天的最高温度、最低温度，以及日出日落、风速等详细数据） - `hourly=true`：逐小时预报（24小时） - `minutely=true`：分钟级降水预报（仅国内城市，精确到2分钟） - `indices=true`：18项生活指数（穿衣、紫外线、洗车、运动、花粉等）  ## 天气字段说明 `weather` 是天气现象文本，不是固定枚举。  常见值包括：晴、多云、阴、小雨、中雨、大雨、雷阵雨、小雪、中雪、大雪、雨夹雪、雾、霾、沙尘。  如果你的业务需要稳定的天气分类，建议使用 `weather_code` 进行映射。完整的天气图标代码请参考[天气图标代码表](#enum-list)。
         * @summary 查询天气
...
export class MiscApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public getMiscTrackingQuery(trackingNumber: string, carrierCode?: string, phone?: string, full?: boolean, options?: RawAxiosRequestConfig) {
        return MiscApiFp(this.configuration).getMiscTrackingQuery(trackingNumber, carrierCode, phone, full, options).then((request) => request(this.axios, this.basePath));
    }
...
export const SocialApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getGithubUser: async (user: string, activity?: boolean, activityScope?: GetGithubUserActivityScopeEnum, org?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SocialApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getGithubUser(user: string, activity?: boolean, activityScope?: GetGithubUserActivityScopeEnum, org?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetGithubUser200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getGithubUser(user, activity, activityScope, org, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const SocialApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getGithubUser(user: string, activity?: boolean, activityScope?: GetGithubUserActivityScopeEnum, org?: string, options?: RawAxiosRequestConfig): AxiosPromise<GetGithubUser200Response> {
            return localVarFp.getGithubUser(user, activity, activityScope, org, options).then((request) => request(axios, basePath));
        },
        /**
         * 想要获取UP主的所有投稿视频？或者想在你的应用里展示创作者的作品集？这个接口能帮你轻松实现。  ## 功能概述 通过用户的 `mid`（用户ID），你可以获取该UP主的投稿视频列表。接口支持关键词搜索、分页加载和多种排序方式，让你能够灵活地展示和分析创作者的内容。  ## 参数说明 - **`mid` (用户ID)**: B站用户的mid，必填参数。 - **`keywords` (搜索关键词)**: 可选，用于在该UP主的投稿中搜索特定关键词。 - **`orderby` (排序方式)**:    - `pubdate`: 按最新发布排序（默认）   - `views`: 按最多播放排序 - **`ps` (每页条数)**: 默认20条。 - **`pn` (页码)**: 默认1，用于分页。  ## 响应体字段说明 - **`total` (总稿件数)**: UP主的投稿总数。 - **`page` (当前页码)**: 当前返回的页码。 - **`size` (每页数量)**: 每页返回的视频数量。 - **`videos` (视频列表)**: 包含当前页的所有视频信息：   - `aid`: 视频的AV号   - `bvid`: 视频的BV号   - `title`: 视频标题   - `cover`: 封面URL   - `duration`: 时长（秒）   - `play_count`: 播放量   - `publish_time`: 发布时间戳   - `create_time`: 创建时间戳   - `state`: 视频状态   - `is_ugc_pay`: 是否付费视频（0=免费，1=付费）   - `is_interactive`: 是否为互动视频
         * @summary 查询 B站投稿
...
export class SocialApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public getGithubUser(user: string, activity?: boolean, activityScope?: GetGithubUserActivityScopeEnum, org?: string, options?: RawAxiosRequestConfig) {
        return SocialApiFp(this.configuration).getGithubUser(user, activity, activityScope, org, options).then((request) => request(this.axios, this.basePath));
    }
