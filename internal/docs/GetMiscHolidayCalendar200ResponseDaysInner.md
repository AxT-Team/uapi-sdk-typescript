...
**is_holiday** | **boolean** | 当天是否存在节日、节气或法定事件。 | [optional] [default to undefined]
**legal_holiday_name** | **string** | 法定节假日名称，无则为空或不返回。 | [optional] [default to undefined]
**legal_holiday_type** | **string** | 法定假日类型：rest 或 workday_adjust。 | [optional] [default to undefined]
**solar_festival** | **string** | 公历节日名称。有值时返回。 | [optional] [default to undefined]
**lunar_festival** | **string** | 农历节日名称。有值时返回。 | [optional] [default to undefined]
**solar_term** | **string** | 节气名称。有值时返回。 | [optional] [default to undefined]
...
```typescript
import { GetMiscHolidayCalendar200ResponseDaysInner } from 'uapi-sdk-typescript';

const instance: GetMiscHolidayCalendar200ResponseDaysInner = {
    date,
    year,
    month,
    day,
