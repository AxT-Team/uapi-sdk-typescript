...
**solar_term** | **string** | 节气，无则为空字符串。 | [optional] [default to undefined]
...
```typescript
import { GetMiscLunartime200ResponseData } from 'uapi-sdk-typescript';

const instance: GetMiscLunartime200ResponseData = {
    query_timestamp,
    query_timezone,
    timezone,
    datetime,
